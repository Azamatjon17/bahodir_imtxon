          ...
          children: [
                        ...
                        children: [
                          Align(
                            ...
                            child: Container(
                              width: 40,
                              height: 40,
                              child: Image.asset("images/afterlogin/circle_avatar1.png"),
                            ),
                          ),
                          Align(
                            ...
                            child: Container(
                              width: 40,
                              height: 40,
                              child: Image.asset("images/afterlogin/circle_avatar2.png"),
                            ),
                          ),
                          Align(
                            ...
                            child: Container(
                              width: 40,
                              height: 40,
                              child: Image.asset("images/afterlogin/circle_avatar3.png"),
                            ),
                          ),
                        ],
                      ),
              ...
              children: [
                Row(
                  children: [
                    ElevatedButton(
                      style: ButtonStyle(
                        shape: WidgetStatePropertyAll(CircleBorder(side: BorderSide.none)),
            ...
            Padding(
              ...
              child: ImortantButtons("Add To Card", () {
                widget.product.itemcount = count;
                SingleProducts.card.add(widget.product);
                print("added");
              }),
            )
          ],
